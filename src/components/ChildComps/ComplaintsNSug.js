...
import { PlusOutlined, LeftOutlined, RightOutlined, ClockCircleOutlined } from "@ant-design/icons";
...
const ComplaintsAndSuggestions = () => {
  ...
  const renderRecordRow = () => {
    return (
      <div style={{boxShadow: '3px 1px 2px rgb(26 26 26 / 20%)', paddingTop: '12px'}}>
      <RecordRow>
        <RecordCol span={24}>
  ...
  return (
    <div>
      <Header style={{ marginBottom: "0" }}>
        ...
        <AuthLink to={'/pages/person/addComplaint'}><PlusOutlined className="side-icon" /></AuthLink>
      </Header>
      <SubHeadings>
        <PaymentSelectors>Completed</PaymentSelectors>
        <PaymentSelectors>Wait</PaymentSelectors>
      </SubHeadings>

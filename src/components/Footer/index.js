...
// local imports 
import { FooterContainer, FooterBars, FooterText, FooterIcons } from "./FooterElements";
...
const Footer = () => {
  ...
  return (
    <FooterContainer>
        <FooterBars>
            <FooterIcons><HomeOutlined /></FooterIcons>
            <FooterText onClick={handleHomeClick}>Home</FooterText>
        </FooterBars>
        <FooterBars>
            <FooterIcons> <SearchOutlined /> </FooterIcons>
            <FooterText onClick={handleSearchClick}>Search</FooterText>
        </FooterBars>
        <FooterBars>
            <FooterIcons><UserOutlined /></FooterIcons>
